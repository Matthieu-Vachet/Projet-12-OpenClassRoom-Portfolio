...
/* Frontend skills */
const Frontend_skill: SkillType[] = [
    {
        skill_name: 'Html',
        Image: DiHtml5,
        size: 70,
...
/* Backend skills */
const Backend_skill: Backend_skillType[] = [
    {
        skill_name: 'Node.JS',
        Image: DiNodejsSmall,
        size: 70,
...
interface Developpement_skillType {
    skill_name: string;
    Image: IconType;
    size: number;
    alt: string;
...
const Developpement_skill: Developpement_skillType[] = [
    {
        skill_name: 'VS Code',
        Image: TbBrandVscode,
        size: 70,
...
interface Conception_skillType {
    skill_name: string;
    Image: IconType;
    size: number;
    alt: string;
...
/* Conception skills */
const Conception_skill: Conception_skillType[] = [
    {
        skill_name: 'Figma',
        Image: TbBrandFigma,
        size: 70,
...
const Footer_Follow: FooterFollowType[] = [
    {
        icon: 'fab fa-twitter',
